...
public class UseCase3TrainConsistMgmnt {
    ...
    public static void main(String[] args) {
        ...
        // HashSet stores only unique values and does not guarantee insertion order
        Set<String> bogies = new HashSet<>();

        // 2. ADD IDs (including duplicates)
        ...
        // These duplicate entries will be ignored internally by HashSet
